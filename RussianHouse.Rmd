...
ggplot(train, aes(x = timestamp, y = price_doc)) + geom_line()
```
...
small.data <- train %>% select(full_sq, life_sq, num_room, build_year, max_floor, state, price_doc)
small.test <- test %>% select(full_sq, life_sq, num_room, build_year, max_floor, state)
